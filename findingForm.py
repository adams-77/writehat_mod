...
class CVSSEngagementFindingForm(EngagementFindingForm,CVSSForm):
    ...
    field_order = ['name','findingGroup','categoryID', 'cwe','cvss_score','description','affectedResources','impact','proofOfConcept','toolsUsed','remediation','references','cvssAV','cvssAC','cvssPR','cvssUI','cvssS','cvssC','cvssI','cvssA','cvssE','cvssRL','cvssRC','cvssCR','cvssIR','cvssAR','cvssMAV','cvssMAC','cvssMPR','cvssMUI','cvssMS','cvssMC','cvssMI','cvssMA',]
...
class DREADEngagementFindingForm(EngagementFindingForm,DREADForm):
    ...
    dreadImpact = forms.MultipleChoiceField( choices=choicesStride,
        label='Background', required=False, widget=forms.SelectMultiple(
