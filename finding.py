...
class BaseDatabaseFinding(WriteHatBaseModel):
    ...
    impact = MarkdownField(max_length=30000, null=True, blank=True)
    cwe = MarkdownField(max_length=100, null=True, blank=True)
    cvss_score = MarkdownField(max_length=100, null=True, blank=True)
